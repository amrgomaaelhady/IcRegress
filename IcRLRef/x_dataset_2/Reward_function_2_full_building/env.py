...
class ArmEnv(object):
    ...
    def __init__(self, mode='easy'):
        ...
        self.df1 = pd.read_csv("shuffled_sec_part_data.csv")
        ...
        self.target = self.df1["gtl_average"][0]
    ...
    def step(self, action, index):
        ...
        self.target = self.df1["gtl_average"][index]
        self.gazing = 0# self.df1["eyegaze_horiz_angle_x"][index]

        prediction = action[0]* 1.5
        ...
        #print(index)
        #print(self.df1['gtl_min_average'][index])
        #print(self.df1['gtl_max_average'][index])
        #print(self.df1['gtl_average'][index])
        hbw = abs(self.df1['gtl_min_average'][index] - self.df1['gtl_max_average'][index])/2
        #print(hbw)
        r = - ( prediction - self.target)**2
        #if(prediction >=self.df1['gtl_min_average'][index] and prediction <= self.df1['gtl_max_average'][index]):
        #    r= 20
            #self.get_point = True
    ...
    def reset(self, ind):
        ...
        #print(ind)
        self.target = self.df1["gtl_average"][ind]
...
class Viewer(pyglet.window.Window):
    ...
    def render(self, x, prediction):
        ...
        self.target = self.data["gtl_average"][x]
